...
export default function AboutSection() {
  ...
  return (
    <>
      <div className="w-[300vw] h-screen px-20 py-5 flex flex-col">
        <div className="text-7xl flex items-center gap-5">
          <img src="/icons/home.png" alt="home-icon" className="w-[100px]" />
          About
        </div>
        ...
        <div className="flex-1 flex items-start mt-10 ml-10 gap-10">
          <div className="w-[400px] flex flex-col items-center text-sm">
          ...
          <div className="w-[400px] flex flex-col items-center text-sm">
            <div className="border border-black rounded-md w-[100%] h-[90%] p-2">
              <div className="bg-stone-500 text-white inline-block px-3 py-1 rounded-full font-semibold">
                Certificate
              </div>
              <div className="p-2">
