...
export function ProjectCardSimple({ slug }: ProjectCardProps) {
  ...
  return (
    <Link href={`/projects/${slug}`}>
      <div className="bg-white border border-zinc-500/50 flex w-full h-full flex-col overflow-hidden hover:shadow-lg transition-transform hover:-translate-y-1 cursor-pointer gap-1">
